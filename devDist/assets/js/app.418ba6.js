...
module.exports = {
  ...
  insertBallNum: 5,
  //选填  要插入的小球数
  rotateGap: Math.PI / 15,
  //选填  旋转幅度
  rotateBallColor: "white",
  ////选填  旋转小球的背景色
...
/* harmony import */ var _needle_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./needle.js */ "./src/needle.js");
...
/* harmony import */ var _babel_runtime_corejs3_core_js_stable_instance_some__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @babel/runtime-corejs3/core-js-stable/instance/some */ "./node_modules/@babel/runtime-corejs3/core-js-stable/instance/some.js");
...
/* harmony import */ var _babel_runtime_corejs3_core_js_stable_instance_fill__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @babel/runtime-corejs3/core-js-stable/instance/fill */ "./node_modules/@babel/runtime-corejs3/core-js-stable/instance/fill.js");
/* harmony import */ var _babel_runtime_corejs3_core_js_stable_instance_fill__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_corejs3_core_js_stable_instance_fill__WEBPACK_IMPORTED_MODULE_9__);
...
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context14; _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_11___default()(_context14 = ownKeys(source, true)).call(_context14, function (key) { _babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_15___default()(target, key, source[key]); }); } else if (_babel_runtime_corejs3_core_js_stable_object_get_own_property_descriptors__WEBPACK_IMPORTED_MODULE_2___default.a) { _babel_runtime_corejs3_core_js_stable_object_define_properties__WEBPACK_IMPORTED_MODULE_1___default()(target, _babel_runtime_corejs3_core_js_stable_object_get_own_property_descriptors__WEBPACK_IMPORTED_MODULE_2___default()(source)); } else { var _context15; _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_11___default()(_context15 = ownKeys(source)).call(_context15, function (key) { _babel_runtime_corejs3_core_js_stable_object_define_property__WEBPACK_IMPORTED_MODULE_0___default()(target, key, _babel_runtime_corejs3_core_js_stable_object_get_own_property_descriptor__WEBPACK_IMPORTED_MODULE_3___default()(source, key)); }); } } return target; }

var baseOptions = __webpack_require__(/*! ./baseOptions.js */ "./src/baseOptions.js");

var Needle =
/*#__PURE__*/
function () {
  function Needle(gameWrap, options) {
    var _context, _context4, _context5;

    _babel_runtime_corejs3_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_16___default()(this, Needle);

    var sizeRatioToRotateLineLength = 3.86;
    var sizeRatioToRotateBallRange = 7.5;
    this._options = _objectSpread({}, baseOptions, {}, options);
    var minLength = Math.min(this._options.canvasWidth, this._options.canvasHeight);
    ...
    this.currentLevel = 1;
    var canvasWidth = this._options.canvasWidth;
    var canvasHeight = this._options.canvasHeight;
    var elementWrap = document.querySelector(gameWrap);
    elementWrap.style.cssText = _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_14___default()(_context = "\n                height: ".concat(canvasHeight, "px;\n\t\t\t\twidth: ")).call(_context, canvasWidth, "px;\n\t\t\t\tmargin:60px auto;\n\t\t\t\tposition:relative;\n\t\t\t\ttransform-style:preserve-3d;\n\t\t\t\tperspective:3000px; \n                /*transform: rotateX(45deg) rotateY(45deg);*/\n    "); //所有canvas元素背景色

    var bgColors = []; //共有多少关， 就有多少canvas 元素

    var elementContentFragment = document.createDocumentFragment();
    var innerAnglePolygons = 360 / this._options.passNum; //多边形内角 每一个面与其下一个面旋转过的角度

    var tanValueInnerAngle = Math.tan(innerAnglePolygons * Math.PI / 360); //转化为弧度的 一半多边形内角 的 正切值

    for (var i = 0, len = this._options.passNum; i < len; i++) {
    ...
    elementContentFragment.appendChild(elementModal); //console.log(elementContentFragment, this._options.passNum);

    elementWrap.appendChild(elementContentFragment); //console.log(elementWrap);
  } //canvas dom元素的背景色


  _babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_17___default()(Needle, [{
    key: "randomBgColor",
    value: function randomBgColor(allBgColor) {
      var newBgColor;
      ...
      do {
        ...
        newBgColor = _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_14___default()(_context6 = _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_14___default()(_context7 = "rgb(".concat(r, ", ")).call(_context7, g, ", ")).call(_context6, b, ")");
      } while (_babel_runtime_corejs3_core_js_stable_instance_includes__WEBPACK_IMPORTED_MODULE_13___default()(allBgColor).call(allBgColor, newBgColor));
    ...
    value: function initOptions() {
      ...
      var rotateBallRange = this._options.rotateBallRange; //旋转小球会撞击的最大角度
    ...
    key: "resetPublicInitOptions",
    value: function resetPublicInitOptions() {
      var elementModal = document.querySelector("#needle-modal");
      this.rotateBallGaps = [];
    ...
    value: function rotateCanvas() {
      ...
      _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_11___default()(_context10 = _babel_runtime_corejs3_core_js_stable_array_from__WEBPACK_IMPORTED_MODULE_10___default()(elementCanvasCollection)).call(_context10, function (elm, i) {
        var _context11;

        var rotateDeg = (i - currentLevel + 1) * innerAnglePolygons;
        rotateDeg = rotateCanvasDirection ? rotateDeg : rotateDeg * -1;
        elm.style.transform = _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_14___default()(_context11 = "\n         rotateX(".concat(rotateDeg, "deg) translateZ(")).call(_context11, canvasHeight / (2 * tanValueInnerAngle), "px)\n       "); //console.log(currentLevel, rotateDeg, elm.style.transform);
      });
    }
  }, {
    key: "stopAnimation",
    ...
    key: "createModalBtns",
    value: function createModalBtns(insertBallNum) {
      var elementModal = document.querySelector("#needle-modal");
      elementModal.className = "needle-modal";
      var currentLevel = this.currentLevel;
      var passGameNum = this._options.passNum;
      var elementResetBtn = this.createResetBtn();
      elementModal.appendChild(elementResetBtn);

      if (!insertBallNum && currentLevel < passGameNum) {
        var elementNextBtn = this.createNextBtn();
        elementModal.appendChild(elementNextBtn);
      }
    }
  }, {
    key: "currentLevelMonitor",
    value: function currentLevelMonitor() {
      var _this = this;
      ...
      var isCrashFun = function isCrashFun() {
        var ballGaps = _this.rotateBallGaps;

        for (var i = 0, len = ballGaps.length; i < len; i++) {
          for (var j = i + 1; j < len; j++) {
            var isCrashed = CrashRad >= Math.abs(ballGaps[i].ballGap % (Math.PI * 2) - ballGaps[j].ballGap % (Math.PI * 2));
            if (isCrashed) return true;
          }
        }
      };

      var monitorCallBack = function monitorCallBack() {
        //console.log(1);
        var insertBallNum = _this.insertBallNum;
        var isCrashed = isCrashFun();

        if (isCrashed || !insertBallNum) {
          //console.log("error", insertBallNum, isCrashed);
          monitorStop(stop);
          isCrashed && _this.stopAnimation(insertBallNum);

          _this.createModalBtns(insertBallNum);

          return false; //console.log(CrashRad,ballGaps, insertBallNum);    
        }
    ...
    value: function clickInsertBall() {
      ...
      var insertBallColor = this._options.rotateBallColor;
      var fontSize = rotateBallRange * .8;
      currentCtx.beginPath();
      currentCtx.strokeStyle = insertBallColor;
      currentCtx.fillStyle = insertBallColor;
      var x = currentCvs.width / 2;
      var y = currentCvs.height / 2 + rotateLineLength;
      ballGaps.push({
        "xNum": x,
        "yNum": y,
        "ballGap": Math.PI / 2,
    ...
    value: function createRotateBallData() {
      ...
      for (var i = 0, len = rotateBallNum; i < len; i++) {
        do {
          randEachGap = Math.random() * Math.PI * 2;
        } while (_babel_runtime_corejs3_core_js_stable_instance_some__WEBPACK_IMPORTED_MODULE_8___default()(ballGaps).call(ballGaps, function (item) {
          return Math.abs(item.ballGap - randEachGap) < crashRad;
        })); //console.log(currentcurrentCvs,currentcurrentCtx);


        var x = currentCvs.width / 2 + Math.cos(randEachGap) * rotateLineLength;
        var y = currentCvs.height / 2 + Math.sin(randEachGap) * rotateLineLength;
        ballGaps.push({
          "xNum": x,
          "yNum": y,
          "ballGap": randEachGap,
    ...
    value: function drawRotateBall(rotateBallColor) {
      ...
      var rotateLineLength = this._options.rotateLineLength;
      var rotateBallRange = this._options.rotateBallRange;
      rotateBallColor = rotateBallColor || this._options.rotateBallColor; //console.log(ballGaps, this.insertBallNum);    
      ...
      for (var i = 0, len = ballGaps.length; i < len; i++) {
        ...
        var x = currentCvs.width / 2 + Math.cos(ballGaps[i].ballGap) * rotateLineLength;
        var y = currentCvs.height / 2 + Math.sin(ballGaps[i].ballGap) * rotateLineLength;
        ballGaps[i].xNum = x;
        ballGaps[i].yNum = y;
    ...
    value: function drawUnderInsertBall() {
      ...
      var rotateLineLength = this._options.rotateLineLength;
      var rotateBallRange = this._options.rotateBallRange;
      var fontSize = rotateBallRange * .8; //console.log(underInsertBallNum);

      for (var i = 0; i < underInsertBallNum; i++) {
        currentCtx.beginPath();
        currentCtx.lineWidth = 2;
        currentCtx.fillStyle = "white";
    ...
    value: function drawAnimtion() {
      ...
      var animateCallBack = function animateCallBack() {
        ...
        _this2.drawRotateBall();

        _this2.drawCenterBall();

        _this2.drawUnderInsertBall();

        _this2.stopTimer = _babel_runtime_corejs3_core_js_stable_set_timeout__WEBPACK_IMPORTED_MODULE_7___default()(animateCallBack, 100);
      };

      this.stopTimer = _babel_runtime_corejs3_core_js_stable_set_timeout__WEBPACK_IMPORTED_MODULE_7___default()(animateCallBack, 100);
    }
  }]);
